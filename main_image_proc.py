...
TRACKBAR_NAME = config["TRACKBAR_NAME"]
TRACKBAR_COUNT = config["TRACKBAR_COUNT"]
TRACKBAR_HEIGHT = config["TRACKBAR_HEIGHT"]
TRACKBAR_DEF_VALUE = config["TRACKBAR_DEF_VALUE"]
HSV_HUE_UPPER_BOUND = config["HSV_HUE_UPPER_BOUND"]
HSV_DEF_UPPER_BOUND = config["HSV_DEF_UPPER_BOUND"]
MIN_CONTOUR_AREA = config["MIN_CONTOUR_AREA"]
MAX_CONTOUR_AREA = config["MAX_CONTOUR_AREA"]
IMAGE_DIR = config["IMAGE_DIR"]
HAAR_FACE_CASCADE_PATH = config["HAAR_FACE_CASCADE_PATH"]
HAAR_EYE_CASCADE_PATH = config["HAAR_EYE_CASCADE_PATH"]
HAAR_SMILE_CASCADE_PATH = config["HAAR_SMILE_CASCADE_PATH"]
FONT_DEF = config["FONT_DEF"]

"""
# use this instead to load all config values from file (will run but IDE likely to give errors)
